...
F2xExtend(scene3.InFour,F2xContainer);
scene3.InFour.prototype.initUI=function(){
	var s = this;
	//f2x_auto_created_init_start
	var _d0=new scene3.F2xAuto_23();
	_d0.name="btns_mc";
	s.btns_mc=_d0;
	Flash2x.d(_d0,{x:250.5,y:229.5});
	var _d1=Flash2x.b("scene3","F2xAuto_90");
	s.addChild(_d1);
	s.addChild(_d0);
